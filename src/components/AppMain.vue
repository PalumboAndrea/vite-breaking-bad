...
<template>
    <div id="main-wrapper" class="container-fluid py-5">
        ...
        <div>
            ...
            <div id="results-number-container" class="container p-5" v-if="store.cardsList.length > 0">
                <div class="row">
                    <div id="results-number" class="col-12 d-flex align-items-center" v-if="store.cardsList.length > 0">
                        <p class="m-0">
